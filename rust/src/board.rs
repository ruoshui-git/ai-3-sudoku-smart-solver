...
pub const NUM_IN_BOARD: usize = 9 * 9;

pub const ALL_RULES: [[usize; 9]; 27] = [
    [0, 1, 2, 3, 4, 5, 6, 7, 8],
...
pub type Rule = [usize; 9];
pub type RuleGroup = [Rule; 9];

#[derive(Clone, Debug, PartialEq, Eq)]
/// An already filled board
pub struct FilledBoard {
    pub(crate) data: [u8; NUM_IN_BOARD],
}
...
impl FilledBoard {
    ...
    pub fn get_distr(&self, rule: &Rule) -> HashMap<u8, Vec<usize>> {
